...
class Advisor(object, metaclass=abc.ABCMeta):
    ...
    def get_suggestion(self, n_suggestion=5, history_container=None):
        """
        ...
        if self.optimization_strategy == 'bo':
            ...
            while is_repeated_config:
                ...
                if cur_config in history_container.configurations:
                    ...
                    repeated_time += 1
                    cur_configs.append(challengers.challengers[repeated_time])
                    if len(cur_configs) == n_suggestion:
